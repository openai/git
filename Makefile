...
TEST_BUILTINS_OBJS += test-semantic-verify.o
...
LIB_OBJS += clean-status-history-store.o
...
LIB_OBJS += exclude-source-proof.o
LIB_OBJS += exec-cmd.o
...
LIB_OBJS += fsck.o
LIB_OBJS += fsmonitor-clean-proof.o
...
CLAR_TEST_SUITES += u-attr-fingerprint
CLAR_TEST_SUITES += u-attr-manifest
CLAR_TEST_SUITES += u-clean-status-config
CLAR_TEST_SUITES += u-clean-status-history
CLAR_TEST_SUITES += u-clean-status-history-store
...
CLAR_TEST_SUITES += u-exclude-source-proof
CLAR_TEST_SUITES += u-fsmonitor-attributes
CLAR_TEST_SUITES += u-fsmonitor-clean-proof
...
CLAR_TEST_SUITES += u-worktree-attr-source
