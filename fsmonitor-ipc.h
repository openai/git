...
#define FSMONITOR_IPC_DARWIN_PROVIDER_FENCE_CAPABILITY \
	"darwin-provider-fence-v1"
#define FSMONITOR_IPC_DARWIN_PROVIDER_FENCE_TOKEN_PREFIX "fence-v1."
...
#define FSMONITOR_IPC_COOKIE_TOKEN_PREFIX \
	...
	FSMONITOR_IPC_DARWIN_PROVIDER_FENCE_TOKEN_PREFIX
